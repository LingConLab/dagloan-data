...
- Lexemes from different lects are grouped by similarity with numbers
...
- Remove "stop-words". If a meaning is represented by different roots in each lect - remove the row.

--

- Number of times two languages share a (similar) root is converted into a distance matrix
